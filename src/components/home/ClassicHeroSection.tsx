      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10 pt-20 sm:pt-24 lg:pt-0">
        <div className="max-w-4xl mx-auto text-center">
          ...
          delay: 0.2
            ...
            <span className="block text-[1.4rem] sm:text-4xl md:text-5xl lg:text-6xl font-bold">
              Building Financial Security.
            </span>
            <span className="block gradient-text-travel text-lg sm:text-3xl md:text-4xl lg:text-5xl font-bold mt-2">
